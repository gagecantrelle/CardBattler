...
function DragAndDrop({gameOn, rounds, nextRound, starterRound, user, mode}:{gameOn: (status: string, win: boolean) => void, rounds: number, nextRound: () => void, starterRound: number, user: Object, mode: string}) {
...
<div className="flex items-center justify-center fixed bottom-0 left-[95vh]">{cards.Rps.map((card)=>{
